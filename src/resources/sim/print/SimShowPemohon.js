...
const SimShowPemohon = ({
  ...
  const createKodeSimDisplay = useCallback(() => {
    if (satlak && sim && pemohon && golongan_sim_tni && permohonan_sim_tni) {
  ...
  const createNamaDisplay = useCallback(() => {
    const nama_display =
      pemohon && pemohon.nama ? pemohon.nama.toUpperCase() : "";
  ...
  const createPangkatNrpNipDisplay = useCallback(() => {
    ...
    const pangkat_nrp_nip_display =
      pangkat_display + korps_display + golongan_pns_display + pemohon_display;
  ...
  const createNamaKomandanDisplay = useCallback(() => {
    const nama_komandan_display =
      satlak && satlak.nama_komandan ? satlak.nama_komandan.toUpperCase() : "";
  ...
  const createStempelSatlakDisplay = useCallback(() => {
    const stempel_satlak_display =
      satlak && satlak.stempel && satlak.stempel.src
        ? satlak.stempel.src
        : null;
            ...
            <TableBody>
              <TableRow>
                <TableCell colspan={2} style={{ "text-align": "center" }}>
                  <img src={pas_foto_display} width={200} />
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell>
                  <Typography>{nama_display}</Typography>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                  <Typography>Tempat/Tgl. Lahir</Typography>
                </TableCell>
                <TableCell>
                  <Typography>{tempat_tanggal_lahir_display}</Typography>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                  <Typography>Pangkat/NRP/NIP</Typography>
                </TableCell>
                <TableCell>
                  <Typography>{pangkat_nrp_nip_display}</Typography>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                  <Typography>Kesatuan</Typography>
                </TableCell>
                <TableCell>
                  <Typography>{kesatuan_display}</Typography>
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
